  ...
  return (
    <div className='w-full flex flex-col justify-center items-center'>
      <div className='md:flex gap-[30px]'>
        <button className='  px-[30px] w-full md:w-fit  py-4 rounded bg-[white] mt-4 md:mt-0  border border-[#FB1314] text-base font-medium text-[#000000]'>Buyer’s Account</button>
        <button className='px-[30px] w-full md:w-fit py-4 rounded bg-[#DB4444] text-base mt-4 md:mt-0 font-medium text-[#FFFFFF]'>Seller’s Account</button>
      </div>
