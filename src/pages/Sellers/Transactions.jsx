        ...
        <div className="flex flex-col ">
          <div className="flex-col lg:flex-row gap-3 flex justify-between">
            ...
            <div className="flex items-center">
              <input placeholder="What are you looking for?" className="bg-[#F5F5F5] w-[391px] max-w-full px-5 py-[11.5px] rounded  text-[12px] font-normal" />
            ...
            <button className="border rounded border-[#000000] px-12 py-[10px] ">Export csv</button>
            </div>
          </div>
                  ...
                  {currentProducts.map((product, index) => (
                    <tr key={index} className=" ">
                      <td className="flex items-center border-b border-b-[#EFEFEF] py-[6px] gap-1 bg-[#F9F9F9]">
                        <img src={product.img} alt={product.name} className="w-12 h-12" />
                        <p className="font-[600] text-sm text-[#191919]">{product.name}</p>
                      </td>
                      <td className=" font-normal text-[#191919] text-sm">{product.collect}</td>
                      <td className=" font-normal text-[#191919] text-sm">{product.variation}</td>
                      <td className=" font-normal text-[#191919] text-sm">{product.inStock}</td>
                      ...
                      <td className="border-b border-b-[#EFEFEF] w-fit text-white  rounded p-2 flex justify-center items-center">
                        <div className="flex items-center justify-center"><img src={icon} /><RiDeleteBin5Fill className="text-[#DB4444] w-5 h-5" /></div>
                      </td>
                    </tr>
                  ))}
                </tbody>
