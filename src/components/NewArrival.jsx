            ...
            <div>
                ...
                <div className='mb-14'>
                            ...
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 gap-7 bg-gray-200'>
                                <img src="../images/Explore-2.png" className='pl-7 mt-4 w-28' alt="Explore Image 1" />
                                ...
                                <button className='bg-black text-white w-52 py-2'>Add To Cart</button>
                            </div>
                            <div className='mt-4'>
                                <div>
                        ...
                        <div className=''>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 bg-gray-200'>
                                <img src="../images/NewArrival-1.png" className=' mt-14 w-36 h-24' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                                ...
                                <div>
                                  ...
                                  <div className='mt-1'>
                                    <div className='flex gap-3'>
                                      <p className='text-sm font-medium text-orange-700'>$160</p>
                        ...
                        <div className=''>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 gap-3 bg-gray-200'>
                                <img src="../images/TheNorthCoat.png" className=' mt-4 w-32' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                        ...
                        <div className=''>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 gap-7 bg-gray-200'>
                                <img src="../images/Explore-1.jpg" className='pl-7 mt-4 w-28' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                        ...
                        <div className=''>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 gap-3 bg-gray-200'>
                                <img src="../images/Explore-8.png" className=' mt-5 h-32 w-32' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                            ...
                            <div className='mt-4'>
                                <div>
                                  ...
                                  {/* <TbPointFilled  className="text-red-500 w-8 h-8"/> */}
                                    <img src="../images/Ellipse 10.png" className='w-3 text-yellow-300 h-3' alt="Elipse" />
                                    <img src="../images/Ellipse 8.png" className='w-3 h-3' alt="Elipse" />
                                   </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex items-start w-52 py-2 pb-6 pr-1  gap-5 bg-gray-200'>
                                ...
                                <div className='flex gap-3'>
                                <img src="../images/Explore-7.png" className='mt-9 mb-8 w-24' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                        ...
                        <div className=''>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  gap-2 bg-gray-200'>
                                <p className='text-white bg-green-400 text-xs ml-1 px-1'>NEW</p>
                                <div className='flex gap-3'>
                                <img src="../images/Explore-5.png" className='mt-10 mb-7 w-28' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                        ...
                        <div className='mt-10'>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 gap-3 bg-gray-200'>
                                <img src="../images/Explore-3.png" className=' mt-4 w-32' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                        ...
                        <div className='flex items-start w-52 py-2 pb-6 pr-1  gap-2 bg-gray-200'>
                                ...
                                <div className='flex gap-3'>
                                <img src="../images/GucciDuffleBag.png" className='mt-8 w-28' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                ...
                                <button className='bg-black text-white flex items-center pl-10 text-xs text-center gap-1 w-52 py-2'><span><IoCartOutline className='text-xl' /></span>Add To Cart</button>
                            </div>
                            ...
                            <div className='mt-4'>
                                <div>
                                  ...
                                  <div className='flex gap-2 mt-1'>
                                    <p className='text-sm font-medium text-orange-700'>$960</p>
                        ...
                        <div className='mt-10'>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-10 gap-3 bg-gray-200'>
                                <img src="../images/SmallBookShelf.png" className=' mt-5 w-28 h-32' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    {/* <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a> */}
                                </div>
                    ...
                    <div className='mt-10'>
                        ...
                        <div className='flex items-start w-52 py-2 pb-6 pr-1 pl-10 gap-2 bg-gray-200'>
                                {/* <p className='text-white bg-red-700 text-xs ml-1 px-1'>-35%</p> */}
                                <div className='flex gap-3'>
                                <img src="../images/IPS LCS GamingMonitor.png" className='mt-8 w-28' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    {/* <a href="#"><RiDeleteBinLine  className='p-1 w-7 h-7 bg-white rounded-full'/></a> */}
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                            ...
                            <div className='mt-4'>
                                <div>
                                  <p className='text-sm font-medium'>IPS LCD Gaming Monitor</p>
                        ...
                        <div className='mt-10'>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 gap-3 bg-gray-200'>
                                <img src="../images/GucciDuffleBag.png" className=' mt-8 mb-6 w-32' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                            ...
                            <div className='mt-4'>
                                <div>
                                  ...
                                  <div className='mt-1'>
                                    <div className='flex gap-3'>
                                      <p className='text-sm font-medium text-orange-700'>$960</p>
                                      <p className='text-sm font-medium text-gray-600 line-through'>$1160</p>
                                    </div>
                        ...
                        <div className='mt-10'>
                            <div className='flex items-start w-52 py-2 pb-6 pr-1  pl-7 bg-gray-200'>
                                <img src="../images/NewArrival-1.png" className=' mt-14 mb-5 w-36' alt="Explore Image 1" />
                                <div className='flex flex-col gap-2 items-center'>
                                    <a href="#"><IoMdHeartEmpty  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                    <a href="#"><IoEyeOutline  className='p-1 w-7 h-7 bg-white rounded-full'/></a>
                                </div>
                            ...
                            <div className='mt-4'>
                                <div>
                                  ...
                                  <div className='flex gap-2 mt-1'>
                                    ...
                                    <p className='text-sm text-gray-400 font-medium line-through'>$1160</p>
                                  </div>
                                   {/* <div className='flex mt-1 gap-2'>
                                    <img src="../images/Ellipse 8.png" className='w-3 h-3' alt="Ellipse" />
                                    <img src="../images/Ellipse 10.png" className='w-3 h-3' alt="Ellipse" />
