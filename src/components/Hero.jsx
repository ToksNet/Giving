...
const Hero = () => {
  ...
  return (
    <>
      <div className="container mx-auto my-10 px-4 mt-20 md:mt-32 md:mx-24 md:mr-16">
        <div className="flex w-full">
          ...
          <div className=" container mx-auto px-4 flex w-4/5 pt-14 pl-12">
            <div className="container bg-black w-3/6 h-[300px] pl-12 pt-12">
              ...
              <div className="mb-5">
                <p className="text-white font-semibold text-5xl tracking-wider">
...
//           <div className="container mx-auto px-4 flex flex-col md:flex-row w-full pt-14 md:pl-12">
...
//               <div className="bg-black w-full h-[300px] p-12">
//                 <div className="flex gap-5 items-center mb-5">
//                   <img
//                     src="../images/HeroApple.png"
//                     className="w-10"
