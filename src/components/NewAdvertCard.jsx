  ...
  return (
    <div className="md:w-[1025px] md:justify-center  mt-32 md:mt-0 bg-white md:p-8">
      ...
      <div className="w-full md:w-[1025px] md:flex md:justify-between mt-5">
        <di v className="relative md:w-[590px] bg-black rounded-md flex md:items-end md:justify-center">
          <img src={image1} alt="Advert 1" className=":w-screen md:w-[511px] mb-4" />
