...
function TimerBanner() {
  return (
    <div className="w-full">
      {" "}
      <div className=" md:mx-32 my-1 border-t-[1px] pt-10 ">
        <div className="p-5 bg-black flex flex-col md:flex-row items-center justify-center md:justify-between relative">
          {/* JBL Sales Label */}
