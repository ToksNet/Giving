...
const AdvertCard = ({ image1, image2, image3, image4 }) => {
  return (
    <div className="md:w-[1025px] md:justify-center mx-auto mt-32 md:mt-0 bg-white md:p-8 sm:p-4">
      ...
      <div className="w-full md:w-[1025px] md:flex md:justify-between mt-5">
        <div className="relative md:w-[590px] bg-black rounded-md flex md:items-end md:justify-center">
          <img
            src={image1}
            alt="Advert 1"
        ...
        <div className="md:w-[590px] mt-5 md:mt-0 flex flex-col justify-between md:ml-4">
          <div className="relative w-full md:w-[432px] bg-black rounded-md flex md:items-end md:justify-end mb-4 ">
            <img
              src={image2}
              alt="Advert 2"
          ...
          <div className="flex mt-1 md:mt-0 md:justify-between">
            <div className="relative w-full md:w-[270px] bg-black rounded-r-md flex items-center justify-center mr-2 md:mr-4">
